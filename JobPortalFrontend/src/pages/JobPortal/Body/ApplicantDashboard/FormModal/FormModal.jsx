    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl text-center font-semibold text-[#3670A3]">Resume</h2>
          <button
            onClick={onClose}
          ...
          <div className="mt-4">
            ...
            <p className="text-[#3670A3]">
              I am highly proficient in Video Editing, leveraging my expertise
              to deliver exceptional results in various projects and
              initiatives.
            </p>
          </div>
